package com.android.biubiu.ui.conversation.models;
...
import com.android.biubiu.ui.conversation.adapter.ChatAdapter;
...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        LinearLayout linearLayout = new LinearLayout(BiubiuApplication.getInstance());
        linearLayout.setOrientation(LinearLayout.HORIZONTAL);
        linearLayout.setGravity(Gravity.CENTER);
        ImageView voiceIcon = new ImageView(BiubiuApplication.getInstance());
        ...
        TextView tv = new TextView(BiubiuApplication.getInstance());
        tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
        tv.setTextColor(BiubiuApplication.getInstance().getResources().getColor(isSelf() ? R.color.white : R.color.black));
    ...
    public String getSummary() {
        return BiubiuApplication.getInstance().getString(R.string.summary_voice);
    }
