...
import com.android.biubiu.transport.http.response.login.LoginData;
    ...
    protected void login(String uName, String uPassword) {
        ...
        x.http().post(params, new CommonCallback<String>() {
            ...
            public void onSuccess(String arg0) {
                ...
                Data<LoginData> response = CommonUtils.parseJsonToObj(arg0, new TypeToken<Data<LoginData>>() {
                });
                if (!CommonUtils.unifyResponse(Integer.parseInt(response.getState()), LoginActivity.this)) {
                    return;
                }
                LoginData data = response.getData();
                String token = data.getToken();
                String hxName = data.getUsername();
                String HxPassword = data.getPassword();
                ...
                String userHead = data.getIcon_url();
