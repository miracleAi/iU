...
public class WheelView2 extends View {
	 ...
	 */
	private int[] SHADOWS_COLORS = new int[] { 0xeffcfcf4, 0xcffcfcf4,
			0x3ffcfcf4 };
	...
	// Recycle
	private WheelRecycle2 recycle = new WheelRecycle2(this);

	// Listeners
	private List<OnWheelChangedListener2> changingListeners = new LinkedList<OnWheelChangedListener2>();
	private List<OnWheelScrollListener2> scrollingListeners = new LinkedList<OnWheelScrollListener2>();
	private List<OnWheelClickedListener2> clickingListeners = new LinkedList<OnWheelClickedListener2>();
	 ...
	 *            the listener
	 */
	public void addChangingListener(OnWheelChangedListener2 listener) {
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		for (OnWheelChangedListener2 listener : changingListeners) {
	 ...
	 *            the listener
	 */
	public void addScrollingListener(OnWheelScrollListener2 listener) {
	...
	protected void notifyScrollingListenersAboutStart() {
		for (OnWheelScrollListener2 listener : scrollingListeners) {
	 ...
	 *            the listener
	 */
	public void addClickingListener(OnWheelClickedListener2 listener) {
	...
	protected void notifyClickListenersAboutClick(int item) {
		for (OnWheelClickedListener2 listener : clickingListeners) {
